        ...
        <div v-if="showFlag">
            <el-form :inline="true" :model="searchForm" class="form-content">
                <el-row :gutter="20" class="slt" :style="{justifyContent:contents.searchBoxPosition=='1'?'flex-start':contents.searchBoxPosition=='2'?'center':'flex-end'}">
                     ...
                     <el-form-item :label="contents.inputTitle == 1 ? '戏曲科普名称' : ''">
                         <el-input prefix-icon="el-icon-search" v-model="searchForm.xiqukepuName" placeholder="戏曲科普名称" clearable></el-input>
                     </el-form-item>
                 
                     <el-form-item :label="contents.inputTitle == 1 ? '戏曲科普类型' : ''">
                        <el-select v-model="searchForm.xiqukepuTypes" placeholder="请选择戏曲科普类型">
                ...
                <el-row class="ad" :style="{justifyContent:contents.btnAdAllBoxPosition=='1'?'flex-start':contents.btnAdAllBoxPosition=='2'?'center':'flex-end'}">
                    <el-form-item>
                        ...
                        <a style="text-decoration:none" class="el-button el-button--success"
                           ...
                           href="http://localhost:8080/xiquwenhuaxiaochengxu/upload/xiqukepuMuBan.xls"
                        >批量导入戏曲科普数据模板</a>
                        &nbsp;
                        <el-upload
                                v-if="isAuth('xiqukepu','导入导出')"
                                ...
                                :action="getActionUrl"
                                :on-success="xiqukepuUploadSuccess"
                                :on-error="xiqukepuUploadError"
                                :show-file-list = false>
                            <el-button
                                    v-if="isAuth('xiqukepu','导入导出')"
                                    type="success"
                                    icon="el-icon-upload2"
                            >批量导入戏曲科普数据</el-button>
                        </el-upload>
                        &nbsp;
                        <!-- 导出excel -->
                        <download-excel v-if="isAuth('xiqukepu','导入导出')" style="display: inline-block" class = "export-excel-wrapper" :data = "dataList" :fields = "json_fields" name = "xiqukepu.xls">
                            <!-- 导出excel -->
                            <el-button
                                    type="success"
                                    icon="el-icon-download"
            ...
            <div class="table-content">
                <el-table class="tables" :size="contents.tableSize" :show-header="contents.tableShowHeader"
                    ...
                    <el-table-column :sortable="contents.tableSortable" :align="contents.tableAlign" prop="xiqukepuPhoto"
                                     header-align="center"
                                     width="200"
                                     label="戏曲科普图片">
                        <template slot-scope="scope">
                            <div v-if="scope.row.xiqukepuPhoto">
                                <img :src="$base.url+scope.row.xiqukepuPhoto" width="100" height="100">
                            </div>
                            <div v-else>无图片</div>
                        </template>
                    </el-table-column>
                    ...
                    <el-table-column width="300" :align="contents.tableAlign"
                        ...
                        <template slot-scope="scope">
                            ...
                            <el-button v-if="isAuth('xiqukepu','查看')" type="success" icon="el-icon-tickets" size="mini" @click="addOrUpdateHandler(scope.row.id,'info')">详情</el-button>
                            <el-button v-if="isAuth('xiqukepu','修改')" type="primary" icon="el-icon-edit" size="mini" @click="addOrUpdateHandler(scope.row.id)">修改</el-button>
                            <el-button v-if="isAuth('xiqukepu','删除')" type="danger" icon="el-icon-delete" size="mini" @click="deleteHandler(scope.row.id)">删除</el-button>
...
<script>
    ...
    //当前表下拉框搜索条件
            ...
            json_fields: {
                ...
                //本表字段
                     '戏曲科普名称': "xiqukepuName",
                     '戏曲科普图片': "xiqukepuPhoto",
                     '戏曲科普类型': "xiqukepuValue",
                     '戏曲科普发布时间': "insertTime",
            },
        ...
        methods: {
            ...
            getDataList() {
                ...
                if (this.searchForm.xiqukepuName!= '' && this.searchForm.xiqukepuName!= undefined) {
                    params['xiqukepuName'] = '%' + this.searchForm.xiqukepuName + '%'
                }
                 
                if (this.searchForm.xiqukepuTypes!= '' && this.searchForm.xiqukepuTypes!= undefined) {
